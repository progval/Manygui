...
from manygui.Utils import getSetter, getGetter
...
that it can send the proper Manygui events (through the send function)
...
class AbstractWrapper:
    ...
    def push(self, state):
        ...
        manygui.Utils.getSetters). This will find the most specific set
