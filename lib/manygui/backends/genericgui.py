...
from manygui.Events import link, send
import manygui.Events as Events
...
class ComboBoxWrapper(Wrapper):
    ...
    def _getLbxY(self):
        ...
        while not mainWindow:
            if isinstance(tmpComp, manygui.Window):
                mainWindow = tmpComp
            else:
    ...
    def _createWidgets(self):
        ...
        self._textFld  = manygui.TextField(geometry = ( x,
                                                       y,
                                                       width - height,
                                                       height ))
        self._popupBtn = manygui.Button(text = 'v',
                                       geometry = ( x + width - height,
                                                    y,
                                                    height,
                                                    height ))
        self._itemLbx = manygui.ListBox(visible = 0,
                                       items = items,
                                       geometry = ( x,
...
class AboutDialog(manygui.Window):

    def __init__(self):
        manygui.Window.__init__(self, title='About Manygui', geometry=(250, 200, 300, 225))
        self.initWidgets()
...
class OpenFileDialog(manygui.Window):

    def __init__(self, dir, filters, sort_rule=DIRS_FIRST):
        manygui.Window.__init__(self, title='Open File - ' + \
                        manygui.application().name + '-' + manygui.application().version, \
